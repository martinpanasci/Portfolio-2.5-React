  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ transform }}
          className="absolute left-1/2 p-4 top-1/2 bg-emerald-300/5 flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)]
            border border-emerald-500/[0.2] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
